 ...
 */
class RoomBathroomVisitRecorder(private val dao: BathroomVisitDao) : BathroomVisitRecorder {

    override suspend fun recordVisit(startedAtMs: Long): Long = dao.insert(
        BathroomVisitEntity(
